    ...
    <div className="p-7 bg-dark-background rounded-xl flex flex-col items-left max-[475px]:w-[300px] w-[442px]">
      <div className="flex justify-between mb-3 w-full">
        <div className="flex flex-col">
          <SubHeader textStyle="text-secondary -mb-1 leading-[46px] max-[475px]:leading-7">
            {title}
          </SubHeader>
        ...
        <div className="flex p-[7px] bg-secondary-gradient rounded-lg max-[475px]:w-20 max-[475px]:h-20 min-[476px]:w-28 min-[476px]:h-28">
          <img
