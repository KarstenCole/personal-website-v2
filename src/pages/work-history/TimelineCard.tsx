...
const TimelineCard = ({ title, img, subTitle, description }: Props) => {
  return (
    <div className="p-7 w-[400px] bg-dark-background rounded-xl flex flex-col items-left max-[475px]:w-[300px]">
      <div className="flex justify-between mb-3 w-full">
        <div className="flex flex-col">
          <SubHeader textStyle="text-secondary -mb-1">{title}</SubHeader>
          <div className="font-manrope text-secondary text-lg mb-4 max-[475px]:text-[12px]">
            {subTitle}
          </div>
        </div>
        <div className="flex p-[7px] bg-secondary-gradient rounded-lg max-[475px] w-24">
